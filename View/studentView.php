    ...
    <table class="table table-striped table-wide">
        ...
        <?php foreach($students AS $student):?>
            <tr>
                ...
                <td><a href="?page=teacherId=<?php echo $student['class_id']?>"><?php echo $student['class_name']?></a></td>
                <td><a href="?page=classId=<?php echo $student['teacher_id']?>"><?php echo $student['teacher_name']?></a></td>
                <td>
